...
public class WineByAlcoholContentActivity extends AppCompatActivity {

    private RecyclerView recyclerViewWineList;
    private WineAdapter wineAdapter;
    private WineDAO wineDAO;
    private int ORIGINAL_COUNTRY_ID = 1;
    private int ALCOHOL_CONTENT = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wine_by_alcohol_content);

        recyclerViewWineList = findViewById(R.id.recycler_view_wine_by_alcohol_content_option_list);
...
//        wineByCountryArrayList.addAll(wineDAO.getAllWines());
        wineByCountryArrayList.addAll(wineDAO.getAllWinesWhereAlcoholContentAndOriginalCountryId(ORIGINAL_COUNTRY_ID, ALCOHOL_CONTENT));
